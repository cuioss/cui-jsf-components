package com.icw.ehf.cui.dev.metadata.composite.attributes;
...
import com.icw.ehf.cui.dev.metadata.composite.util.LabelValueDisplay;
...
public abstract class AbstractPropertyWrapper implements Serializable {
    ...
    protected static String getRequired(final FeatureDescriptor featureDescriptor) {
        String required = String.valueOf(Boolean.FALSE);
        final ValueExpression ve = (ValueExpression) featureDescriptor.getValue(ATTRIBUTE_REQUIRED);
        Object object = null;
        if (null != ve) {
    ...
    protected static String getShortDesctiption(final FeatureDescriptor featureDescriptor) {
        String required;
        final ValueExpression ve = (ValueExpression) featureDescriptor.getValue(ATTRIBUTE_REQUIRED);
        final Object object = ve.getValue(FacesContext.getCurrentInstance().getELContext());
        if (null == object) {
            required = QA_REQUIRED_NOT_DEFINED;
        } else {
            required = String.valueOf(object);
