...
public final class DisplayXmlCode extends UINamingContainer {
    ...
    private BeanInfo getMetadataInfo() {
        if (null == metadata) {
            synchronized (this) {
                ResourceHandler resourceHandler = getFacesContext().getApplication()
                        .getResourceHandler();
    ...
    public String getSampleFacetSource() {
        final javax.servlet.ServletContext context = (javax.servlet.ServletContext) getFacesContext()
                .getExternalContext().getContext();
        final SampleSourceFinder sampleSourceFinder = new SampleSourceFinder(new File(
