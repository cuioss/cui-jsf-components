 ...
 */
var cuiUpdateCollapsiblePanelServerState = function (panelId, isExpanded, event) {
    //build submit params
    var options = {};
 ...
 */
var cuiUpdateCollapsiblePanelState = function (panelId, isExpanded, event) {
    var panelStateHolder = jQuery(PrimeFaces.escapeClientId(panelId) + "_isexpanded");
    if (panelStateHolder) {
        panelStateHolder.val(isExpanded);
        var parent = panelStateHolder.parent();
        if (parent) {
 ...
 */
var intitializeCuiPanelUpdate = function () {
