...
import de.cuioss.jsf.components.chart.model.Ticks;
import de.cuioss.jsf.components.chart.options.LabelOptions;
import de.cuioss.jsf.components.chart.options.TickOptions;
import de.cuioss.jsf.components.chart.plugin.IPluginConsumer;
import de.cuioss.jsf.components.chart.plugin.PluginSupport;
import de.cuioss.jsf.components.chart.renderer.AxisTickRenderer;
import de.cuioss.jsf.components.chart.renderer.LabelRenderer;
