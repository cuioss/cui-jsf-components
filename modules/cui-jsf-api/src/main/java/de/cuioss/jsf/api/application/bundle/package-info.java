...
<managed-bean>
    <managed-bean-name>msgs</managed-bean-name>
         <managed-bean-class>de.cuioss.jsf.api.application.bundle.CuiResourceBundle</managed-bean-class>
...
<managed-bean>
    ...
    <managed-bean-class>de.cuioss.jsf.api.application.bundle.ResourceBundleWrapperImpl</managed-bean-class>
    <managed-bean-scope>request</managed-bean-scope>
    <managed-property>
