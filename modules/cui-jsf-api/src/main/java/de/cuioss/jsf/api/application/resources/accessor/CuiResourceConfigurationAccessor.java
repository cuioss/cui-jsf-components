 ...
 *
 */
public class CuiResourceConfigurationAccessor extends ManagedBeanAccessor<CuiResourceConfiguration> {
    ...
    public CuiResourceConfigurationAccessor() {
        super(CuiResourceConfigurationImpl.BEAN_NAME, CuiResourceConfiguration.class, false);
    }
