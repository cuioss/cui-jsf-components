...
public interface StyleClassBuilder {
    ...
    /**
     * @return the styleClass. It will never return null but an empty String if
     *         no style-class is set.
     */
    ...
    /**
     * @param styleClass
     *            to be appended to the styleClass string. If it is null or
    ...
    /**
     * @param styleClassBuilder
     *            If it is null or empty it will be ignored. The same for
     *            duplicate entries.
     * @return the resulting {@link StyleClassBuilder} instance. If it is null
     *         or empty it will be ignored. The same for duplicate entries.
     */
    StyleClassBuilder append(StyleClassBuilder styleClassBuilder);

    /**
     * @param styleClassProvider
     *            If it is null or empty it will be ignored. The same for
     *            duplicate entries.
     * @return the resulting {@link StyleClassBuilder} instance. If it is null
     *         or empty it will be ignored. The same for duplicate entries.
    ...
    /**
     * @param styleClass
     *            to be removed from the styleClass string. If it is null or
    ...
    /**
     * Analogous to jQuery.toggleClass(): If a class is present remove it. If
     * not add it.
     *
     * @param styleClass
     *            to be toggle within the styleClass string. If it is null or
     *            empty it will be ignored.
     * @return the resulting {@link StyleClassBuilder} instance
     */
