 ...
 * <h2>Summary</h2>
 * <p>
 * Implementors of this class manage the state and resolving of the placeholder attribute. The
 * implementation relies on the correct user of the attribute names, saying they must exactly match
 * the accessor methods.
 * </p>
 * <h2>placeholderKey</h2>
 * <p>
 * The key for looking up the text for the placeholder pass through attribute. Although this
 * attribute is not required
 * you must provide either this or #placeholderValue if you want a placeholder to be displayed.
 * </p>
 * <h2>placeholderValue</h2>
 * <p>
 * The Object displayed for the placeholder pass through attribute. This is a replacement for
 * #placeholderKey. If both are
 * present placeholderValue takes precedence. This object is usually a String. If not, the developer
 * must ensure that a corresponding converter is either registered for the type or must provide a
 * converter using #placeholderConverter.
 * </p>
 * <h2>placeholderConverter</h2>
 * <p>
 * The optional converterId to be used in case of placeholderValue is set and needs conversion.
 * </p>
 *
...
public class PlaceholderProvider {
    ...
    public String resolvePlaceholder() {
        ...
        return LabelResolver.builder().withLabelKey(placeholderKey).withStrictMode(false)
                .withLabelValue(placeholderValue).withConverter(getPlaceholderConverter())
                .build().resolve(componentBridge.facesContext());
    }
     ...
     *
     * @param forComponent
     *            The (child-)component to display the text in.
     * @param facesContext
     *            The current FacesContext.
     * @param self
     *            The (parent-)component containing the forComponent. Here the
     *            watermark will be added as child.
     */
