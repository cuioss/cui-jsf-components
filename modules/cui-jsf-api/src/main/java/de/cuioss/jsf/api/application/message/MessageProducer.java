...
public interface MessageProducer extends Serializable {
     ...
     */
    FacesMessage getMessageFor(String messageKey, FacesMessage.Severity severity,
            Object... parameter);

    /**
     * Convenience Method for
     * {@link #getMessageFor(String, javax.faces.application.FacesMessage.Severity, Object...)} with
    ...
    /**
     * Convenience Method for
     * {@link #getMessageFor(String, javax.faces.application.FacesMessage.Severity, Object...)} that
     * sets in addition the Messages into the {@link FacesContext}
     *
     * @param messagekey must no be null FacesMessage.Severity severity
     * @param severity The Severity level of the Message, must not be null.
     ...
     * @param parameter Ellipses of Object Parameter for MessageFormat
     */
    void setFacesMessage(String messagekey, FacesMessage.Severity severity, String componentId,
            Object... parameter);

    /**
     * Convenience Method for setting Faces messages without resource bundle resolving
     *
     ...
     */
    void addMessage(@NonNull final String message,
            @NonNull final FacesMessage.Severity severity, final String componentId, final Object... parameter);
    ...
    /**
     * Convenience Method for setting global Faces messages without resource bundle resolving
     *
     * @param message must not be null
     * @param severity must no be null FacesMessage.Severity severity
     * @param parameter optional Ellipses of Object Parameter for MessageFormat
