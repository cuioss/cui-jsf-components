...
/**
 * Extension to omnifaces {@link State} providing specific methods for dealing with primitive
 * types
 *
 * @author Oliver Wolff
 *
...
public class CuiState extends State {
    ...
    /**
     * Shorthand for accessing {@link #getBoolean(Serializable, boolean)} with {@code false} for the
     * default value
     *
     * @param key to be checked
     * @return the boolean representing the value, {@code false} if the given key is not found
     */
    ...
    /**
     * Shorthand for accessing {@link #getInt(Serializable, int)} with {@code 0} for the
     * default value
     *
     * @param key to be checked
     * @return the int representing the value, {@code 0} if the given key is not found
     */
