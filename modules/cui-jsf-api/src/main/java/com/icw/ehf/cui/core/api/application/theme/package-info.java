 ...
 * "com.icw.portal.css" {@link com.icw.ehf.cui.core.api.application.theme.ThemeResourceHandler}
 * </p>
 * <p>
 * The classes / interfaces within this package:
 * <ul>
 * <li>{@link com.icw.ehf.cui.core.api.application.theme.ThemeResourceHandler}: Is the actual
 * {@link javax.faces.application.ResourceHandler} delivering the css to the client. In order to do
 * so it needs instances of {@link com.icw.ehf.cui.core.api.application.theme.ThemeConfiguration}
 * and
 * {@link com.icw.ehf.cui.core.api.application.theme.ThemeNameProducer} to be present. This both
 * classes
 ...
 *
 * <pre>
 * {@code <resource-handler>com.icw.ehf.cui.core.api.application.theme.ThemeResourceHandler</resource-handler>}
 * </pre>
 *
 * In order to work instances of
 * {@link com.icw.ehf.cui.core.api.application.theme.ThemeConfiguration} and
 * {@link com.icw.ehf.cui.core.api.application.theme.ThemeNameProducer} are to be registered as
 * managed-beans
 * using the corresponding names</li>
 * <li>{@link com.icw.ehf.cui.core.api.application.theme.ThemeConfiguration}: Defines what themes
 * are
 * available, what is the default theme and some technical aspects like names and paths. The default
 * implementation {@link com.icw.ehf.cui.core.api.application.theme.impl.ThemeConfigurationImpl}
 * suffices for
 ...
 * <li>{@link com.icw.ehf.cui.core.api.application.theme.ThemeNameProducer}: Simple abstraction over
 * defining
 * the actual theme at runtime. The default implementation
 * {@link com.icw.ehf.cui.core.api.application.theme.impl.ThemeNameProducerImpl} is for testing
 * purposes only
 * and must be replaced by a proper implementation. It will always return the derived defaultTheme
 * by {@link com.icw.ehf.cui.core.api.application.theme.ThemeConfiguration}</li>
 * </ul>
 * </p>
 *
