...
import com.icw.ehf.cui.core.api.components.javascript.ComponentWrapperJQuerySelector.ComponentWrapperJQuerySelectorBuilder;
import com.icw.ehf.cui.core.api.components.javascript.JavaScriptOptions.JavaScriptOptionsBuilder;
...
public class Selectize implements ScriptProvider {
    ...
    public String script() {
        return String.format(JS_TEMPLATE, jQuerySelector.script(), options.script());
    }
