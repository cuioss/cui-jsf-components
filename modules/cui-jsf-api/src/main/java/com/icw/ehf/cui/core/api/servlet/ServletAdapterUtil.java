...
public final class ServletAdapterUtil {
    ...
    /**
     * <h1>ATTENTION: May contain POST parameters. Consider using
     * {@link NavigationUtils#extractUrlParameters(Object)}</h1>
     *
     * Accesses the contained RequestParameterMap
     *
     * @param facesContext representing current state. Must not be
     * @return corresponding RequestParameterMap
     *
     * @deprecated use instead {@link NavigationUtils#extractUrlParameters(Object)}
     */
    // owolff old api. ParameterMap should always be of type String, String[]
    @Deprecated
    public static Map<String, String[]> getParameterMap(FacesContext facesContext) {
        return getRequest(facesContext).getParameterMap();
    }
