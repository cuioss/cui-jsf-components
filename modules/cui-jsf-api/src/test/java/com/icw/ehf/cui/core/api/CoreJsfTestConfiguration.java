package com.icw.ehf.cui.core.api;
...
import com.icw.ehf.cui.core.api.application.bundle.ResourceBundleWrapperImpl;
...
import com.icw.ehf.cui.core.api.application.message.MessageProducer;
import com.icw.ehf.cui.core.api.application.message.MessageProducerImpl;
import com.icw.ehf.cui.core.api.components.JsfHtmlComponent;
import com.icw.ehf.cui.core.api.converter.ObjectToStringConverter;
...
public class CoreJsfTestConfiguration extends BasicApplicationConfiguration
    ...
    public static final String CUI_BUNDLE_BASE_PATH = "de.icw.cui.core.l18n.";
